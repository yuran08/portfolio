...
export const UserMessageWrapper = ({
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-gray-100 p-6 shadow-sm transition-shadow duration-200 hover:shadow-md">
...
export const AssistantMessageWrapper = ({
  ...
  return (
    <div className="rounded-2xl border border-blue-100 bg-blue-50 p-6 shadow-sm transition-shadow duration-200 hover:shadow-md">
      <div className="flex items-start gap-3">
