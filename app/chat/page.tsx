      ...
      <div className="flex h-full w-full flex-col items-center justify-center bg-white p-6 dark:bg-slate-950">
        <div className="w-full max-w-3xl">
          ...
          <div className="mb-8 text-center">
            ...
            {/* 标题 */}
            <h1 className="mb-2 text-2xl font-bold text-gray-800 dark:text-slate-200 sm:text-3xl">
              开始新对话
            </h1>
            ...
            {/* 功能特点 */}
            <div className="mt-6 flex flex-wrap justify-center gap-4 text-xs text-gray-500 dark:text-slate-500 sm:text-sm">
