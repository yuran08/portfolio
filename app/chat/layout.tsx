...
export default function ChatPageLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={`${geistSans.variable} ${geistMono.variable} flex h-screen bg-black text-white antialiased`}
      >
        <aside className="flex w-72 flex-col space-y-4 border-r border-gray-700 p-4">
          ...
          <div className="flex-1 space-y-2 overflow-y-auto">
            ...
            <div className="cursor-pointer truncate rounded p-2 text-sm hover:bg-gray-700">
              placeholder
            </div>
          ...
          <div className="mt-auto border-t border-gray-700 pt-4">
            <div className="flex cursor-pointer items-center space-x-2 rounded p-2 hover:bg-gray-700">
